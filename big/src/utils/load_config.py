...
class LoadConfig:
    ...
    def __init__(self) -> None:
        ...
        # openai_api_key = "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"  # Replace with your actual OpenAI API key
    ...
    def load_openai_cfg(self):
        ...
        openai.api_key = os.getenv("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")
